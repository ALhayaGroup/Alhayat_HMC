...
class HrContract(models.Model):
    ...
    work_nature_allowance = fields.Monetary(string="Work Nature Allowance", help="Work Nature allowance")
    supervision_allowance = fields.Monetary(string="Supervision Allowance", help="Supervision allowance")
    special_allowance = fields.Monetary(string="Special Allowance", help="Special allowances")
